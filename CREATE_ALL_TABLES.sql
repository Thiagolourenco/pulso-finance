-- ============================================
-- Script SQL COMPLETO para criar todas as tabelas do Pulso
...
DROP TRIGGER IF EXISTS update_card_invoices_updated_at ON card_invoices;
...
DROP POLICY IF EXISTS "Users can view their own card purchases" ON card_purchases;
CREATE POLICY "Users can view their own card purchases"
  ON card_purchases FOR SELECT
  USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can insert their own card purchases" ON card_purchases;
CREATE POLICY "Users can insert their own card purchases"
  ON card_purchases FOR INSERT
  WITH CHECK (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can update their own card purchases" ON card_purchases;
CREATE POLICY "Users can update their own card purchases"
  ON card_purchases FOR UPDATE
  USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can delete their own card purchases" ON card_purchases;
CREATE POLICY "Users can delete their own card purchases"
  ON card_purchases FOR DELETE
  USING (auth.uid() = user_id);

-- Policy: card_invoices
DROP POLICY IF EXISTS "Users can view their own card invoices" ON card_invoices;
CREATE POLICY "Users can view their own card invoices"
  ON card_invoices FOR SELECT
  USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can insert their own card invoices" ON card_invoices;
CREATE POLICY "Users can insert their own card invoices"
  ON card_invoices FOR INSERT
  WITH CHECK (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can update their own card invoices" ON card_invoices;
CREATE POLICY "Users can update their own card invoices"
  ON card_invoices FOR UPDATE
  USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can delete their own card invoices" ON card_invoices;
