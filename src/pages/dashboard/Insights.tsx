  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="mb-8 pb-6 border-b border-border">
        <h1 className="text-h1 font-bold text-neutral-900 mb-2">Insights</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="p-6 bg-white rounded-card-lg border border-border">
          <p className="text-caption text-neutral-600 mb-2">Receitas do Mês</p>
        ...
        <div className="p-6 bg-white rounded-card-lg border border-border">
          <p className="text-caption text-neutral-600 mb-2">Despesas do Mês</p>
        ...
        <div className="p-6 bg-white rounded-card-lg border border-border">
          <p className="text-caption text-neutral-600 mb-2">Sobra Prevista</p>
          <p className={`text-h2 font-bold ${expectedSurplus >= 0 ? 'text-success-600' : 'text-danger-600'}`}>
        ...
        <div className="p-6 bg-white rounded-card-lg border border-border">
          <p className="text-caption text-neutral-600 mb-2">Investimentos</p>
      ...
      {/* Top 5 Despesas */}
      <div className="p-6 bg-white rounded-card-lg border border-border">
        <h2 className="text-h3 font-semibold text-neutral-900 mb-4">Top 5 Despesas</h2>
            ...
            {topExpenses.map((expense, index) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-body-sm font-medium text-neutral-900">{expense.description}</p>
